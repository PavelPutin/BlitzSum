...
# Form implementation generated from reading ui file 'D:\PycharmProjects\BlitzSum\gui\Rules.ui'
#
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 735, 1655))
    ...
    def retranslateUi(self, RulesMenu):
        ...
        self.label_3.setText(_translate("RulesMenu", "<html><head/><body><p><span style=\" font-size:14pt;\">Четвёртый семестр в самом разгаре! Сможешь ли ты сдать сессию с наибольшим счётом!</span></p><p><span style=\" font-size:14pt;\">Твоя задача, выполняя аттестации, набрать как можно больше очков! Всего есть 10 предметов.</span></p><p><span style=\" font-size:18pt; font-weight:600;\">Экзамены:</span></p><p><img src=\":/rules-preview/rules-preview/PHILOSOPHY.png\"/><span style=\" font-size:14pt;\"> - философия</span></p><p><img src=\":/rules-preview/rules-preview/ENGLISH.png\"/><span style=\" font-size:14pt;\">- английский</span></p><p><img src=\":/rules-preview/rules-preview/MATEQ.png\"/><span style=\" font-size:14pt;\"> - урмат</span></p><p><img src=\":/rules-preview/rules-preview/LANGUAGES.png\"/><span style=\" font-size:14pt;\"> - ЯиСП</span></p><p><span style=\" font-size:18pt; font-weight:600;\">Зачёты с оценкой:</span></p><p><img src=\":/rules-preview/rules-preview/HMI.png\"/><span style=\" font-size:14pt;\"> - ЧМИ</span></p><p><span style=\" font-size:18pt; font-weight:600;\">Обычные зачёты:</span></p><p><img src=\":/rules-preview/rules-preview/CALCULATION_METHODS.png\"/><span style=\" font-size:14pt;\"> - методы вычислений</span></p><p><img src=\":/rules-preview/rules-preview/TIPIS.png\"/><span style=\" font-size:14pt;\"> - ТИПиС</span></p><p><img src=\":/rules-preview/rules-preview/UNIX.png\"/><span style=\" font-size:14pt;\"> - ОС UNIX</span></p><p><img src=\":/rules-preview/rules-preview/ELECTRONICS.png\"/><span style=\" font-size:14pt;\"> - электроника</span></p><p><img src=\":/rules-preview/rules-preview/PE.png\"/><span style=\" font-size:14pt;\"> - физра</span></p><p><span style=\" font-size:14pt;\">иииииииииииииии...</span></p><p><span style=\" font-size:18pt; font-weight:600; color:#c8bc0d;\">- ХАЛЯВА!</span></p><p><span style=\" font-size:14pt;\">Очки за сданные аттестации начисляются, если суммарная оценка по ним равна 100 баллам.</span></p><p><span style=\" font-size:14pt;\">Если тебе удалось сдать аттестации только за счёт </span><span style=\" font-size:14pt; color:#c8bc0d;\">ХаЛяВы</span><span style=\" font-size:14pt;\">, то 100 баллов умножаются на 100!</span></p><p><span style=\" font-size:14pt;\">Если ты сдал аттестации по </span><span style=\" font-size:14pt; font-weight:600;\">одному предмету</span><span style=\" font-size:14pt;\">, то 100 баллов </span><span style=\" font-size:14pt; font-weight:600;\">умножаются</span><span style=\" font-size:14pt;\"> на множитель этого предмета:</span></p><p><span style=\" font-size:14pt;\">- для экзамена - </span><span style=\" font-size:14pt; font-style:italic;\">2х</span></p><p><span style=\" font-size:14pt;\">- для зачёта с оценкой - </span><span style=\" font-size:14pt; font-style:italic;\">1.5х</span></p><p><span style=\" font-size:14pt;\">- для обычного зачёта - </span><span style=\" font-size:14pt; font-style:italic;\">1х</span></p><p><span style=\" font-size:14pt;\">А если ты ещё и </span><span style=\" font-size:14pt; color:#c8bc0d;\">Х</span><span style=\" font-size:16pt; color:#c8bc0d;\">А</span><span style=\" font-size:18pt; color:#c8bc0d;\">Л</span><span style=\" font-size:20pt; color:#c8bc0d;\">Я</span><span style=\" font-size:18pt; color:#c8bc0d;\">В</span><span style=\" font-size:16pt; color:#c8bc0d;\">К</span><span style=\" font-size:14pt; color:#c8bc0d;\">У</span><span style=\" font-size:14pt;\"> залутал, то этот результат увеличивается в </span><span style=\" font-size:14pt; font-weight:600;\">10 раз</span><span style=\" font-size:14pt;\">!</span></p><p><span style=\" font-size:14pt;\">Если же аттестации сдавались по разным предметам, то... получишь </span><span style=\" font-size:14pt; font-weight:600;\">100 очков</span><span style=\" font-size:14pt;\">. Но не унывай! Ведь если среди этих предметов была </span><span style=\" font-size:14pt; color:#c8bc0d;\">ХАЛЯВА</span><span style=\" font-size:14pt; color:#000000;\">, то эти </span><span style=\" font-size:14pt; font-weight:600; color:#000000;\">100 очков</span><span style=\" font-size:14pt; color:#000000;\"> умножатся на </span><span style=\" font-size:14pt; font-weight:600; color:#000000;\">самый большой множитель</span><span style=\" font-size:14pt; color:#000000;\"> из сданных аттестаций.</span></p><p><span style=\" font-size:14pt;\">Также не забывай, что полученные очки </span><span style=\" font-size:14pt; font-weight:600;\">умножаются</span><span style=\" font-size:14pt;\"> на количество сданных аттестаций!</span><br/></p><p><span style=\" font-size:14pt; font-weight:600;\">Успешной сессии, студент!</span></p></body></html>"))
import resources_rc
